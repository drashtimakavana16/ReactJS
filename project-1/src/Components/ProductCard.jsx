    ...
    <div className="card bg-white rounded-4xl p-4 w-full max-w-sm overflow-hidden shadow-2xl relative">
      ...
      <div className="absolute z-10 top-6 left-8">
        ...
        <div className="content px-6 py-2">
            ...
            <p className='text-gray-400/60 font-medium mb-2 text-sm '>{data.details}</p>

            <div className="price flex items-center justify-between mt-2">
                <h1 className='rounded-full bg-gray-200 px-3 py-1 text-black font-bold'>{data.price}</h1>
                <div className='flex items-center gap-2 bg-black text-white rounded-full px-3 py-1'>
