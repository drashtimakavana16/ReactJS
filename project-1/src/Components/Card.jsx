...
const Card = ({data}) => {
  ...
  return (
    <>
      <div className="card w-full h-auto max-w-md bg-green-950 rounded-[10%] p-4 text-white shadow">
        <div className="bg-green-800 text-center  rounded-b-[12%] rounded-[10%] overflow-hidden">
         
            <img src={data.photo} alt="img" className="w-112 h-100 object-cover rounded-[10%]"/>
           <span className="py-1"> Free Delivery Untill 30/3/2026</span>
        </div>
        ...
        <div className="content px-6 flex justify-between items-center py-2">
          ...
          <div className="price p-2 border-l-2 border-green-400/20 ">
            ...
            <p className="flex gap-4 items-center text-[14px]">Order Now
               <span className="inline-block"><MoveUpRight strokeWidth={3} className="w-3.5 h-3.5"/></span></p>
          </div>
        </div>
      </div>
    </>
